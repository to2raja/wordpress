...
/* <![CDATA[*/
	function poll_default_templates(template) {
		...
		switch(template) {
			case "voteheader":
				default_template = "<p style=\"text-align: left;\">%POLL_QUESTION%</p>\n<div id=\"polls-%POLL_ID%-ans\" class=\"wp-polls-ans\">\n<ul class=\"wp-polls-ul\">";
				break;
			case "votebody":
				...
				break;
			case "votefooter":
				default_template = "</ul>\n<p style=\"text-align: left;\"><input type=\"button\" name=\"vote\" value=\"   <?php _e('Vote', 'wp-polls'); ?>   \" class=\"button p1\" onclick=\"poll_vote(%POLL_ID%);\" /></p>\n<p class=\"action\" style=\"text-align: left;\"><a href=\"#ViewPollResults\" class=\"button\" onclick=\"poll_result(%POLL_ID%); return false;\" title=\"<?php _e('View Results Of This Poll', 'wp-polls'); ?>\"><?php _e('View Results', 'wp-polls'); ?></a></p>\n</div>";
				break;
			case "resultheader":
				default_template = "<p style=\"text-align: left;\" class=\"dfndrPollQuestion\" >%POLL_QUESTION%</p>\n<div id=\"polls-%POLL_ID%-ans\" class=\"wp-polls-ans\">\n<ul class=\"wp-polls-ul\">";
				break;
			case "resultbody":
				...
				default_template =	"<li><p class=\"pollResult\"><strong>%POLL_ANSWER_PERCENTAGE%%</strong>%POLL_ANSWER%</p></li>";
				break;
			case "resultbody2":
			...
			case "resultfooter":
				...
				default_template = "</ul><p><strong>%POLL_TOTALVOTERS% Total Votes</strong></p>";
				break;
			case "resultfooter2":
				//default_template = "</ul>\n<p style=\"text-align: center;\"><?php _e('Total Voters', 'wp-polls'); ?>: <strong>%POLL_TOTALVOTERS%</strong></p>\n<p style=\"text-align: left;\"><a href=\"#VotePoll\" onclick=\"poll_booth(%POLL_ID%); return false;\" title=\"<?php _e('Vote For This Poll', 'wp-polls'); ?>\"><?php _e('Back to Voting', 'wp-polls'); ?></a></p>\n</div>";
				default_template = "</ul><a href=\"#VotePoll\" class=\"button\" onclick=\"poll_booth(%POLL_ID%); return false;\" title=\"<?php _e('Vote For This Poll', 'wp-polls'); ?>\"><?php _e('Back', 'wp-polls'); ?></a>";
				break;
